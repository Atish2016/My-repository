				...
				<div id="top" class="callbacks_container">
					<ul class="rslides" id="slider4">
						<li><img class="img-responsive"
							src="<c:url value="/resources/images/slide1.jpg"/>" alt="">
						...
						<li><img src="<c:url value="/resources/images/slide2.jpeg"/>"
							alt="">
						<li><img src="<c:url value="/resources/images/slide3.jpg"/>"
							alt="">
							<div class="slider-caption">
								<h1>Beautiful & durable</h1>
								<p>Classically simple and beautifully elegant Hard wearing
		...
		<div class="container">
			<div class="col-md-4 top-grid text-center">
				<div class="top-grid-pic">
					<img src="<c:url value="/resources/images/pic01.png"/>"
						title="Boots" /> <span>Boots</span>
				</div>
			...
			<div class="col-md-4 top-grid text-center">
				<div class="top-grid-pic">
					<img src="<c:url value="/resources/images/pic02.png"/>"
						title="Boots" /> <span>Casual</span>
				</div>
				<div class="top-grid-pic-info">
					<a href="single-page.html">Seeall</a>
				</div>
			...
			<div class="col-md-4 top-grid text-center">
				<div class="top-grid-pic">
					<img src="<c:url value="/resources/images/pic03.png"/>"
						title="Boots" /> <span>Formal</span>
				</div>
				<div class="top-grid-pic-info">
					<a href="single-page.html">Seeall</a>
				</div>
		...
		<div class="container">
						...
						<div id="owl-demo1" class="owl-carousel text-center">
							...
							<div class="item">
								<div onclick="location.href='single-page.html';"
									class="product-grid">
									<div class="product-pic">
										<img src="<c:url value="/resources/images/p5.jpg"/>"
											title="Elliot Boots" />
									</div>
									<div class="product-pic-info">
										<h3>
							...
							<div class="item">
								<div onclick="location.href='single-page.html';"
									class="product-grid">
									<div class="product-pic">
										<img src="<c:url value="/resources/images/p6.jpg"/>"
											title="Elliot Boots" />
									</div>
									<div class="product-pic-info">
										<h3>
			...
			<div class="col-md-3 bottom-grids-right">
				...
				<div class="shhiping text-center">
					<h2>Free Shipping</h2>
					<a href="#"><img
						src="<c:url value="/resources/images/offer-pic.png"/>"
						title="$250" /></a>
				</div>
			</div>
			<div class="clearfix"></div>
